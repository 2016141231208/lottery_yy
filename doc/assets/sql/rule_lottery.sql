...
-- ----------------------------
BEGIN;
INSERT INTO `activity` VALUES (1, 100001, '活动名', '测试活动', '2023-03-29 00:00:00', '2023-03-31 23:59:59', 100, 88, 10, 10001, 5, 'xiaofuge', '2023-01-08 20:14:50', '2023-01-08 20:14:50');
INSERT INTO `activity` VALUES (3, 100002, '活动名02', '测试活动', '2023-03-29 00:00:00', '2023-03-31 23:59:59', 100, 100, 10, 10001, 5, 'xiaofuge', '2023-04-02 15:49:21', '2021-04-02 15:49:21');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `award` VALUES (1, '1', 1, 'IMac', 'Code', '2023-01-15 15:38:05', '2023-01-15 15:38:05');
INSERT INTO `award` VALUES (2, '2', 1, 'iphone', 'Code', '2023-01-15 15:38:05', '2023-01-15 15:38:05');
INSERT INTO `award` VALUES (3, '3', 1, 'ipad', 'Code', '2023-01-15 15:38:05', '2023-01-15 15:38:05');
INSERT INTO `award` VALUES (4, '4', 1, 'AirPods', 'Code', '2023-01-15 15:38:05', '2023-01-15 15:38:05');
INSERT INTO `award` VALUES (5, '5', 1, 'Book', 'Code', '2023-01-15 15:38:05', '2023-01-15 15:38:05');
COMMIT;
-- ----------------------------
...
-- ----------------------------
BEGIN;
INSERT INTO `rule_tree` VALUES (2110081902, '抽奖活动规则树', '用于决策不同用户可参与的活动', 1, '2023-04-05 15:38:05', '2023-04-05 15:38:05');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `strategy` VALUES (1, 10001, 'test', 2, 1, NULL, '', '2023-02-25 08:15:52', '2023-02-25 08:15:52');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `strategy_detail` VALUES (1, 10001, '1', 'IMac', 10, 0, 0.05, '2023-01-15 15:38:05', '2023-01-15 15:38:05');
INSERT INTO `strategy_detail` VALUES (2, 10001, '2', 'iphone', 20, 20, 0.15, '2023-01-15 15:38:05', '2023-01-15 15:38:05');
INSERT INTO `strategy_detail` VALUES (3, 10001, '3', 'ipad', 50, 50, 0.20, '2023-01-15 15:38:05', '2023-01-15 15:38:05');
INSERT INTO `strategy_detail` VALUES (4, 10001, '4', 'AirPods', 100, 79, 0.25, '2023-01-15 15:38:05', '2023-01-15 15:38:05');
INSERT INTO `strategy_detail` VALUES (5, 10001, '5', 'Book', 500, 390, 0.35, '2023-01-15 15:38:05', '2023-01-15 15:38:05');
COMMIT;
