...
public class SpringRunnerTest {
    ...
    public void test_award(){
        ...
        GoodsReq goodsReq=new GoodsReq(drawResult.getuId(),"2109313442431",drawAwardInfo.getRewardId(),drawAwardInfo.getAwardName(),drawAwardInfo.getAwardContent());
